...
#elif defined( CONFIG_MACH_LYNX_DL60 )
#define CONFIG_SMARTPHONE_PIERCE 1
				...
				enum snd_jack_types jack_type)
{
	...
	if (!insertion) {
		...
		if (mbhc->mbhc_cfg->detect_extn_cable &&
		    ...
		    (mbhc->hph_status && mbhc->hph_status != jack_type)) {
#endif /* CONFIG_SH_AUDIO_DRIVER */ /*09-051*//*09-079*/
			if (mbhc->micbias_enable && mbhc->micbias_enable_cb &&
			...
			mbhc->zl = mbhc->zr = 0;
#ifdef CONFIG_SH_AUDIO_DRIVER /*09-082*/
			wcd9xxx_set_and_turnoff_hph_padac(mbhc);
#endif /* CONFIG_SH_AUDIO_DRIVER */ /*09-082*/
			wcd9xxx_jack_report(mbhc, &mbhc->headset_jack,
					    0, WCD9XXX_JACK_MASK);
#ifdef CONFIG_SH_AUDIO_DRIVER /*09-051*/
			msleep(100);
#endif /* CONFIG_SH_AUDIO_DRIVER */ /*09-051*/
...
#endif /* CONFIG_SMARTPHONE_PIERCE */
#if !defined( CONFIG_SH_AUDIO_DRIVER ) /* invalid range disable */
		if ((!d->mic_bias &&
...
#ifdef CONFIG_SH_AUDIO_DRIVER /*09-076*/
...
#endif /* CONFIG_SH_AUDIO_DRIVER */ /*09-076*/
	do {
		if (cs_enable) {
...
#ifdef CONFIG_SH_AUDIO_DRIVER /* 09-004 */
	if ((mbhc->current_plug != PLUG_TYPE_HEADSET) && (mbhc->current_plug != PLUG_TYPE_ANC_HEADPHONE)) {
		pr_debug("%s: plug type is %d. ignore\n", __func__, mbhc->current_plug);
		goto done;
	}
	//mbhc sometimes crached by unexpected dce_handler call
	wcd9xxx_update_z(mbhc);
#endif /* CONFIG_SH_AUDIO_DRIVER */ /* 09-004 */
	if (mbhc->mbhc_state == MBHC_STATE_POTENTIAL_RECOVERY) {
...
/* COORDINATOR Qualcomm_PostCS MERGE start */
	#ifdef CONFIG_SH_AUDIO_DRIVER /* 07-004 */
	...
	#endif /* CONFIG_SH_AUDIO_DRIVER */ /* 07-004 */
/* COORDINATOR Qualcomm_PostCS MERGE end */
