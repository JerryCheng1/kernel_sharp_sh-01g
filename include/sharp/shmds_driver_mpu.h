...
enum {
	SHMDS_STOP_PED_TYPE_VIB,
	NUM_SHMDS_STOP_PED_TYPE
};
extern atomic_t report_flg;
extern int shmds_api_stop_pedometer_func(int);
extern int shmds_api_restart_pedometer_func(int);
