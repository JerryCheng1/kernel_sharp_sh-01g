...
#define	SHIRDA_DEVFILE_NAME2		"msm_shirda2"
#define	SHIRDA_DEVFILE2			"/dev/"SHIRDA_DEVFILE_NAME2
#define	SHIRDA_DEVFILE_NAME3		"msm_shirda3"
#define	SHIRDA_DEVFILE3			"/dev/"SHIRDA_DEVFILE_NAME3
