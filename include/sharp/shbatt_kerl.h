...
{
	SHBATT_LIMIT_LOCK_300000KHz = 300000,
	SHBATT_LIMIT_LOCK_422400KHz = 422400,
	SHBATT_LIMIT_LOCK_652800KHz = 652800,
	SHBATT_LIMIT_LOCK_729600KHz = 729600,
	SHBATT_LIMIT_LOCK_883200KHz = 883200,
	SHBATT_LIMIT_LOCK_960000KHz = 960000,
	SHBATT_LIMIT_LOCK_1036800KHz = 1036800,
	SHBATT_LIMIT_LOCK_1190400KHz = 1190400,
	SHBATT_LIMIT_LOCK_1267200KHz = 1267200,
	SHBATT_LIMIT_LOCK_1497600KHz = 1497600,
	SHBATT_LIMIT_LOCK_1574400KHz = 1574400,
	SHBATT_LIMIT_LOCK_1728000KHz = 1728000,
	SHBATT_LIMIT_LOCK_1958400KHz = 1958400,
	SHBATT_LIMIT_LOCK_2265600KHz = 2265600,
	SHBATT_LIMIT_LOCK_HIGHEST = SHBATT_LIMIT_LOCK_2265600KHz,
...
typedef enum shchg_state_tag
{
	SHCHG_STATE_IDLE,
	SHCHG_STATE_CHECK,
	SHCHG_STATE_FAST,
	SHCHG_STATE_HOT_FAST,
	SHCHG_STATE_COLD_FAST,
	SHCHG_STATE_AWAIT,
	SHCHG_STATE_MAINTENANCE,
	SHCHG_STATE_ERROR_CHG_POWER_SHORTAGE,
	SHCHG_STATE_ERROR_CHG_ABNORMAL,
	SHCHG_STATE_ERROR_BAT_ABNORMAL,
	SHCHG_STATE_ERROR_BAT_ID_INVALID,
	SHCHG_STATE_TEMP_CHECK,
	SHCHG_STATE_HIGH_TEMP_WAIT,
	NUM_SHCHG_STATE
} shchg_state_t;
...
typedef struct shbatt_calc_base_info_tag
{
	int				capacity;
	int				bat_therm[2];
	unsigned int	rtc_data[2];
	unsigned char	pon_pbl_status;
} shbatt_calc_base_info_t;
