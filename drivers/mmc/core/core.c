...
int sh_mmc_status_flags = 0;
module_param_named(sh_status_flags, sh_mmc_status_flags, int, S_IRUGO|S_IWUSR);
MODULE_PARM_DESC(sh_debug_mask, "eMMC tuning status param");
