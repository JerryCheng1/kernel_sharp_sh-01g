						...
						unsigned int baud)
{
	...
	if (msm_hsl_port->use_irda) {
		...
		case 300:
			/* 30.0KHz */
			baud_code = UARTDM_CSR_3600;	/* 0x6 */
			port->uartclk = 15360000;
			break;
		case 600:
			/* 32.7KHz */
			baud_code = UARTDM_CSR_4800;	/* 0x7 */
			port->uartclk = 12556800;
			break;
		case 1200:
			/* 33.0KHz */
			baud_code = UARTDM_CSR_4800;	/* 0x7 */
			port->uartclk = 12672000;
			break;
		case 1800:
			/* 33.3KHz */
			baud_code = UARTDM_CSR_4800;	/* 0x7 */
			port->uartclk = 12787200;
			break;
		case 2400:
			/* 36KHz */
			baud_code = UARTDM_CSR_4800;	/* 0x7 */
			port->uartclk = 13824000;
			break;
		case 4800:
			/* 36.7KHz */
			baud_code = UARTDM_CSR_4800;	/* 0x7 */
			port->uartclk = 14092800;
			break;
		case 9600:
			/* Used for IrDA */
			baud_code = UARTDM_CSR_2400;
			break;
		case 14400:	/* Linux: Not support */
			/* 37.9KHz */
			baud_code = UARTDM_CSR_4800;	/* 0x7 */
			port->uartclk = 14553600;
			break;
		case 19200:
			/* Used for IrDA */
			baud_code = UARTDM_CSR_4800;
			break;
		case 28800:	/* Linux: Not support */
			/* 40.0KHz */
			baud_code = UARTDM_CSR_4800;	/* 0x7 */
			port->uartclk = 15360000;
			break;
		...
		case 500000:
			/* 56.0KHz */
			baud_code = UARTDM_CSR_4800;	/* 0x7 */
			port->uartclk = 21504000;
			break;
		case 576000:
			/* 56.9KHz */
			baud_code = UARTDM_CSR_4800;	/* 0x7 */
			port->uartclk = 21849600;
			break;
		case 921600:
			/* 37.9KHz */
			baud_code = UARTDM_CSR_4800;	/* 0x7 */
