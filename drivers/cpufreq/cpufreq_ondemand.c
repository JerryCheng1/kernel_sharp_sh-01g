...
#define NR_CORE_INPUT_EVENT				(2)
#define MIGRATION_FREQ				(1190400)
#define SAMPLING_LATE_MDSS_MDP_CLK_ENABLE	(20000)
#define DEF_FREQUENCY_THRESHOLD_ONDEMAND_STEPHIGH		(94)
...
static struct dbs_tuners {
	...
	.boosted_sampling_down_factor = 3,
...
#ifdef CONFIG_SHSYS_CUST
	{
		if (i >= NR_CORE_INPUT_EVENT) break;
#endif /* CONFIG_SHSYS_CUST */
