...
/* SHMDS_ID_1202_01 add S */
#define POWER_UP_UTIME           100000
#define REG_UP_UTIME             2000
#define STANDBY_WAIT_UTIME       60000
#define SENSOR_UP_UTIME          30000
/* SHMDS_ID_1202_01 add E */
...
#define INIT_PEDOMETER_MAX_STEP_BUFFER_TIME 150
#define INIT_PEDOMETER_THRESHOLD            33757317
#define INIT_PEDOMETER_MIN_UP_TIME          16
#define INIT_PEDOMETER_MAX_UP_TIME          60
...
#define SMD_TIMER_ADD             0
#define SMD_TIMER_MOD             1
#define SMD_REPORT                1
#define SMD_NO_REPORT             0
...
/* SHMDS_ID_0201_01 add S */
	int (*diag_read_data)(struct inv_mpu_state *, char *buf);
	int (*diag_self_test)(struct inv_mpu_state *, char *buf);
/* SHMDS_ID_0201_01 add E */
	u64 prev_ts;
};
...
/* for adb debug */
    ...
    ATTR_SHMDS_COUNT,
    ATTR_SHMDS_THS_VALUE,
    ATTR_SHMDS_DURATION_VALUE,
    ATTR_SHMDS_BUF_SIZE_TEMP,
    ATTR_SHMDS_MD_THRESH,
    ATTR_SHMDS_MG_TO_LSB,
    ATTR_SHMDS_MD_THRESH_VALUE,
...
/* SHMDS_ID_0201_01 add S */
	ATTR_DIAG_RAW_GYRO,
	ATTR_DIAG_RAW_ACCEL,
	ATTR_DIAG_RAW_COMPASS,
	ATTR_DIAG_POWER_STATE,
	ATTR_DIAG_GYRO_ENABLE,
	ATTR_DIAG_ACCL_ENABLE,
	ATTR_DIAG_COMPASS_ENABLE,
	ATTR_DIAG_PORT_STATE,
	ATTR_DIAG_REFERENCE_REGISTER,
	ATTR_DIAG_RW_REGISTET,
	ATTR_DIAG_COMPASS_SELF_TEST,
/* SHMDS_ID_0201_01 add E */
};
