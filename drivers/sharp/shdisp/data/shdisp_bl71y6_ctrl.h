...
#include "shdisp_bl71y6_data_dl63.h"
#elif defined(CONFIG_MACH_LYNX_DL60)
#include "shdisp_bl71y6_data_dl60.h"
#elif defined(CONFIG_MACH_REN)
#include "shdisp_bl71y6_data_pa26.h"
#elif defined(CONFIG_MACH_DECKARD_AL15)
#include "shdisp_bl71y6_data_al15.h"
#else   /* defined(CONFIG_MACH_LYNX_DL63) */
...
static const shdisp_bdicRegSetting_t shdisp_bdic_init2[] = {
     ...
     {BDIC_REG_GPIO_2,              SHDISP_BDIC_STR,    BDIC_REG_GPIO_2_VAL,        0xFF,      0},
