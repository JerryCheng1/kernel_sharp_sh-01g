...
#if defined(FEATURE_SH_MODEL_DL60) || defined(CONFIG_MACH_LYNX_DL60)
...
#if defined(FEATURE_SH_MODEL_DL50) || defined(CONFIG_MACH_LYNX_DL50) \
 || defined(FEATURE_SH_MODEL_AS99) || defined(CONFIG_MACH_DECKARD_AS99)
...
#endif
#if defined(FEATURE_SH_MODEL_DL60) || defined(CONFIG_MACH_LYNX_DL60)
#define VALID_GPIO_DTV_STDBY	GPIO_VALID
#endif
